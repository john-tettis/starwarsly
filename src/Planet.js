...
/**
 * Renders information on a single planet. Retreives id from url params, 
 * dispatches api call, waits for response, and renders information.
 * Includes 2 SubLists of 1. films including this planet, 2.people from this planet
 */
function Planet() {
  const {id} = useParams();
